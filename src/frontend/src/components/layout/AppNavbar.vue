        ...
        <div class="flex items-center gap-3">
          ...
          <div v-else class="relative" ref="userMenuRef">
            ...
            <div v-if="userMenuOpen"
              ...
              <!-- Doctor links -->
              <RouterLink v-if="auth.user?.role === 'Doctor'" to="/doctor/appointments" @click="userMenuOpen = false"
                class="flex items-center gap-2 px-4 py-2 text-sm text-teal-700 hover:bg-teal-50">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                </svg>
                Quản lý lịch hẹn
              ...
              <!-- Messages -->
              <RouterLink to="/messages" @click="userMenuOpen = false"
                class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <!-- Prescriptions -->
              <RouterLink to="/prescriptions" @click="userMenuOpen = false"
                class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
